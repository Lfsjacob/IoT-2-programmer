...
def opdater_prognose_db():
    ...
    opdatering_tidspunkter = [3, 7, 11, 15, 19, 23]
    nu_tid = datetime.now()
    ...
    if nu_sammenlagt > opdatering_tidspunkter_sek[0] and nu_sammenlagt < opdatering_tidspunkter_sek[1]:
        ...
        print(f"Sover i {sleep_tid} sekunder indtil kl. {int(opdatering_tidspunkter[1])}:00")
        sleep(sleep_tid)
        ...
        print(f"Sover i {sleep_tid} sekunder indtil kl. {int(opdatering_tidspunkter[2])}:00")
        sleep(sleep_tid)
        ...
        print(f"Sover i {sleep_tid} sekunder indtil kl. {int(opdatering_tidspunkter[4])}:00")
        sleep(sleep_tid)
        ...
        print(f"Sover i {sleep_tid} sekunder indtil kl. {int(opdatering_tidspunkter[5])}:00")
        sleep(sleep_tid)
    elif nu_sammenlagt > opdatering_tidspunkter_sek[5]:
        sleep_tid = ((24 * 3600) - nu_sammenlagt) + opdatering_tidspunkter_sek[0]
        print(f"Sover i {sleep_tid} sekunder indtil kl. {int(opdatering_tidspunkter[0])}:00")
        sleep(sleep_tid)
